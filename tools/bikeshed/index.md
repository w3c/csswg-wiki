...
Bikeshed is best installed with [Pipx](https://speced.github.io/bikeshed/#install-pipx); Linux distributions with <code>apt</code> can install it from there, and the Pipx install page has instructions for other OSes.
