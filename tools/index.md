...
- GitHub issues in [csswg-drafts](https://github.com/w3c/csswg-drafts/issues), [fxtf-drafts](https://github.com/w3c/fxtf-drafts/issues), and [css-houdini-drafts](https://github.com/w3c/css-houdini-drafts/issues) are used to track spec issues.
  - Older spec issues are found in the mail archives, and might be additionally tracked in [CSS Tracker](https://www.w3.org/Style/CSS/Tracker/), [FXTF Tracker](https://www.w3.org/Graphics/fx/track/), [Bugzilla](https://www.w3.org/Bugs/Public/), and [this wiki](/spec/).)
